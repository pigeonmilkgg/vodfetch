...
EN = {
    ...
    "cite_done": "Copied",
    "tool_drop_hint": "Paste a link, drop it here, or just type a channel name",
    ...
    "related_pages_h": "Related pages",
    "faq_hub_cta": "More questions? See the full Twitch downloader FAQ",
    ...
    "cb_exp_left": "left (est.)",
    "cb_more": "Load more",
    "cb_not_found": "Channel not found, or it has no public VODs or clips.",
    "un_label": "Twitch username",
    "un_ph": "e.g. shroud",
    "un_btn": "Check username",
    "un_checking": "Checking against Twitch…",
    "un_taken_t": "This username is taken",
    "un_taken_d": "{name} exists on Twitch — the account was created on {date}.",
    "un_free_t": "No channel with this name",
    "un_free_d": "No Twitch channel named “{name}” was found. The name is not in use right now — but that does not guarantee you can register it: Twitch holds back names of renamed, suspended and reserved accounts.",
    "un_live": "live now",
    "un_partner": "Partner",
    "un_affiliate": "Affiliate",
    "un_browse": "Browse this channel's VODs & clips →",
    "un_invalid": "Usernames are 4–25 characters: letters, numbers and underscores.",
    "un_error": "Could not reach Twitch — please try again in a moment.",
    "fc_label": "Twitch channel name",
    "fc_ph": "e.g. papaplatte",
    "fc_btn": "Check follower count",
    "fc_result": "As of {time}, {name} has {count} followers on Twitch.",
    "fc_live": "live now — {v} watching",
    "fc_created": "The account was created on {date} — about {years} years on Twitch.",
    "fc_recheck": "Check again",
    "cb_p_day": "Today",
    "cb_p_week": "This week",
    ...
    "tool_from": "From",
    "tool_to": "To",
    "tool_chat": "⬇ Chat export",
    "tool_chapters": "⬇ Chapters (.txt)",
    "tool_chapters_hint": "Export game/category change timestamps — great for chapters if you re-upload.",
    ...
    "about_sections": [
        {"heading": "What it does", "body": "vodfetch downloads past Twitch broadcasts, highlights, clips and live streams in their original source quality — up to 1080p60 — and saves them as ordinary MP4 files that play anywhere and import cleanly into editors like Premiere, DaVinci Resolve or CapCut. Beyond plain video it can extract audio only, turn a short clip into a GIF, export a VOD's chat replay as a timestamped text file, and pull the game-change chapter markers from a stream. No account, no watermark, no install and no upsell."},
...
DE = {
    ...
    "cite_done": "Kopiert",
    "tool_drop_hint": "Link einfügen, hierher ziehen — oder einfach einen Kanalnamen tippen",
    "tool_drop_msg": "Loslassen zum Analysieren",
    "paa_h2": "Häufige weitere Fragen",
    ...
    "related_pages_h": "Verwandte Seiten",
    "faq_hub_cta": "Mehr Fragen? Zur vollständigen Twitch-Downloader-FAQ",
    ...
    "cb_exp_left": "übrig (geschätzt)",
    "cb_more": "Mehr laden",
    "cb_not_found": "Channel nicht gefunden oder hat keine öffentlichen VODs/Clips.",
    "un_label": "Twitch-Username",
    "un_ph": "z. B. shroud",
    "un_btn": "Username prüfen",
    "un_checking": "Prüfe direkt bei Twitch…",
    "un_taken_t": "Dieser Username ist vergeben",
    "un_taken_d": "{name} existiert auf Twitch — der Account wurde am {date} erstellt.",
    "un_free_t": "Kein Kanal mit diesem Namen",
    "un_free_d": "Es wurde kein Twitch-Kanal namens „{name}“ gefunden. Der Name ist aktuell nicht in Benutzung — das garantiert aber nicht, dass du ihn registrieren kannst: Twitch sperrt Namen von umbenannten, gebannten und reservierten Accounts.",
    "un_live": "gerade live",
    "un_partner": "Partner",
    "un_affiliate": "Affiliate",
    "un_browse": "VODs & Clips dieses Kanals ansehen →",
    "un_invalid": "Usernames haben 4–25 Zeichen: Buchstaben, Zahlen und Unterstriche.",
    "un_error": "Twitch ist gerade nicht erreichbar — bitte gleich noch einmal versuchen.",
    "fc_label": "Twitch-Kanalname",
    "fc_ph": "z. B. papaplatte",
    "fc_btn": "Follower-Zahl prüfen",
    "fc_result": "Stand {time}: {name} hat {count} Follower auf Twitch.",
    "fc_live": "gerade live — {v} schauen zu",
    "fc_created": "Der Account wurde am {date} erstellt — seit rund {years} Jahren auf Twitch.",
    "fc_recheck": "Erneut prüfen",
    "cb_p_day": "Heute",
    "cb_p_week": "Diese Woche",
    ...
    "tool_to": "Bis",
    "tool_chat": "⬇ Chat export",
    "tool_chapters": "⬇ Kapitel (.txt)",
    "tool_chapters_hint": "Exportiert Spiel-/Kategoriewechsel als Zeitstempel — ideal für Kapitel bei Re-Uploads.",
    ...
    "about_sections": [
        {"heading": "Was es macht", "body": "vodfetch lädt vergangene Twitch-Übertragungen, Highlights, Clips und Live-Streams in originaler Source-Qualität — bis 1080p60 — und speichert sie als ganz normale MP4-Dateien, die überall abspielen und sich sauber in Editoren wie Premiere, DaVinci Resolve oder CapCut importieren lassen. Über reines Video hinaus kann es auch nur die Tonspur extrahieren, einen kurzen Clip in ein GIF verwandeln, den Chat-Verlauf eines VODs als Textdatei mit Zeitstempeln exportieren und die Kapitelmarken (Spielwechsel) eines Streams auslesen. Ohne Account, ohne Wasserzeichen, ohne Installation und ohne Upsell."},
